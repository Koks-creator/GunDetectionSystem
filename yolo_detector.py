...
if __name__ == "__main__":
    ...
    # img = cv2.imread(rf"{Config.TEST_DATA_FOLDER}/gunsondupaxd_1_73.jpeg")
    ...
    cap = cv2.VideoCapture(rf"C:\Users\table\PycharmProjects\MojeCos\amerykasimulator\Videos\8717592-sd_960_506_25fps.mp4")
    p_time = 0
    while cap.isOpened():
